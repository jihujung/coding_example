...
function maskNumberBack(){
	...
	if(jumin2){
		var maskedNumber = numberBack.slice(0, -1) + '*';
		 document.getElementById('jumin2').value = maskedNumber;
	}
}
...
<form>
 <table width="1400" height="650">
  ...
  주민번호 : <input type = "text" name = "jumin1" id = "jumin1"> -  <input type = "text" name = "jumin2" id = "jumin2" onkeyup="maskNumberBack()"><br><br>
